...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addStringOption(option => option.setName('hexcolor').setDescription('The color of your embed, this should be a hex color with a # at the start.').setRequired(false)),
